...
<title>Insert title here</title>
	<link href="resources/css/freeListStyle.css?var=1" rel="stylesheet" type="text/css">
               ...
               <thead>
                ...
                <tbody>
                	<c:forEach var="row" items="${boardList}">
						<tr>
							<td class="table_no">${row.nboard_id}</td>
							<td class="table_cate">${row.category}</td>
							<td class="table_title"><a href="/noticeDetail?nboard_id=${row.nboard_id}">${row.title}</a></td>
